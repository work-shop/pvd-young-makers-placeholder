...
<footer id="footer" class="block">
	<div class="container-fluid">
		<div class="row ">
			<div class="offset-xs-1 col-xs-10   col-md-7 offset-md-1    footer-col mb2">
                <div class="row">
                    <div class="col-sm-12">
			...
			<div class="offset-xs-1 col-xs-10    offset-lg-0 col-lg-3    footer-col">
                <div class="row">
                    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="offset-sm-1 col-sm-6 site-credit">
                <a href="http://workshop.co" target="_blank">
                    <h6 class="brand-teal tiny">Site by <span class="work-shop-link">Work-Shop Design Studio</span></h6>
                </a>
            </div>
        </div>
